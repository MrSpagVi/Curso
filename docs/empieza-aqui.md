...
Detalles, comparación, plantillas: **[Sistema de notas](plan/notas.md)**.

Aprender la habilidad (4 semanas en paralelo a tu lectura): **[Tutorial — Aprender a tomar notas (plan de 30 días)](plan/notas-tutorial.md)**.
...
<iframe src="https://www.youtube.com/embed/xhm55mIdSuk?rel=0" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; border: 0;" title="Yale PLSC 114 Lecture 1" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
</div>

[:material-youtube: Playlist completa (24 clases gratis, Yale)](https://www.youtube.com/playlist?list=PL8D95DEA9B7DFE825){ .md-button .md-button--primary target="_blank" rel="noopener" }
