---
title: Fase 3 — Sociopolítica del siglo XX
---

# Fase 3 — Pensamiento sociopolítico contemporáneo

**Mes 13-17 · ~30-35 h de lectura efectiva · 1 lectura fija + 3 corrientes elegidas**
...
- :material-check-circle: Definir **Estado, legitimidad, vocación política** con Weber.
- :material-check-circle: Resumir en 5 minutos qué defienden **marxismo, liberalismo y conservadurismo del siglo XX** sin caricaturas.
- :material-check-circle: Explicar qué es **hegemonía** (Gramsci), **imperialismo** (Lenin), **constructivismo de mercado** (Hayek), **decisionismo** (Schmitt).
- :material-check-circle: Aplicar el concepto de **interseccionalidad** (Crenshaw) a un caso concreto.
- :material-check-circle: Identificar cómo Arendt distingue **totalitarismo** de mera dictadura.
...
### Kimberlé Crenshaw — TED Talk "The Urgency of Intersectionality" (~18 min)

[:material-open-in-new: Verla en TED.com (con subtítulos en español)](https://www.ted.com/talks/kimberle_crenshaw_the_urgency_of_intersectionality){ .md-button .md-button--primary target="_blank" rel="noopener" }

### Hannah Arendt — Totalitarismo (~30-40 min, español)

<div style="position: relative; padding-bottom: 56.25%; height: 0; overflow: hidden; margin: 1rem 0;">
<iframe src="https://www.youtube.com/embed/MdefaBhhgaQ?rel=0" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; border: 0;" title="Hannah Arendt totalitarismo" allowfullscreen></iframe>
</div>

### Gramsci — Hegemonía cultural (Educatina, ~15 min)

<div style="position: relative; padding-bottom: 56.25%; height: 0; overflow: hidden; margin: 1rem 0;">
<iframe src="https://www.youtube.com/embed/eVB-7km1XG8?rel=0" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; border: 0;" title="Gramsci hegemonía Educatina" allowfullscreen></iframe>
</div>

### Otros recomendados

- :material-youtube: [Roger Scruton — búsqueda de conferencias en YouTube](https://www.youtube.com/results?search_query=roger+scruton+lecture) — la mejor exposición del conservadurismo filosófico (inglés, subs).
- :material-youtube: [Diego Fusaro (italiano, hay vídeos con subs español)](https://www.youtube.com/results?search_query=diego+fusaro+español) — marxismo "conservador", muy cercano a tesis de Armesilla.
...
|--------|---------|---------|-------|--------|
| **Lectura fija** | 1-2 | Weber — *Política como vocación* | (introductorio) | Ficha de Weber |
| **Corriente A** | 3-6 | (la que elegiste) | Vídeo correspondiente | Ficha de la corriente |
| **Corriente B** | 7-10 | (la que elegiste) | Vídeo correspondiente | Ficha de la corriente |
...
1. Weber: ¿qué es el **monopolio de la violencia legítima**? ¿Qué tipos de **legitimidad** distingue?
2. ¿Cuál es la diferencia entre **ética de la convicción** y **ética de la responsabilidad**? ¿Cuál te parece superior y por qué?
3. Gramsci: ¿qué es **hegemonía cultural**? ¿Cómo se construye y cómo se rompe?
4. Hayek: ¿por qué el cálculo socialista es imposible según él? ¿Refutarías ese argumento?
5. Schmitt: la distinción **amigo/enemigo** como esencia de lo político — ¿es descriptiva o normativa?
6. Arendt: ¿qué hace **totalitario** a un régimen, más allá de "dictatorial"?
7. Crenshaw: dame un caso donde un análisis solo de género NO ve la opresión completa pero un análisis interseccional sí.

---

## :material-format-list-checks: Autoevaluación Bloom — Fase 3

- [ ] **Nivel 3 — Aplicar:** uso conceptos de Gramsci/Hayek/Crenshaw para analizar el debate político español o latinoamericano actual.
- [ ] **Nivel 4 — Analizar:** identifico las premisas antropológicas de cada corriente (qué presupone el conservador, el liberal, el marxista del siglo XX sobre la naturaleza humana).
- [ ] **Nivel 5 — Evaluar:** sostengo un debate de 30 min defendiendo cualquiera de las 3 corrientes que estudié (incluso las que no comparto) con argumentos no caricaturizados.

**Objetivo de salida:** Nivel 4 mínimo en 2 de las 3 corrientes.

---

## :material-earth: Informes institucionales del trimestre

- [ ] **[Real Instituto Elcano](https://www.realinstitutoelcano.org)** — un análisis de política exterior.
- [ ] **[V-Dem Democracy Report](https://www.v-dem.net)** — el informe anual de calidad democrática mundial.
- [ ] **[CEPAL](https://www.cepal.org)** — un informe sobre Latinoamérica.

---

[:material-arrow-right-bold: Fase 4 — Tradiciones iberoamericanas](fase-4.md){ .md-button .md-button--primary }
[:material-arrow-left: Fase 2 — Economía política](fase-2.md){ .md-button }
