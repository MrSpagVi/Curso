/* ============================================================
   ...
   - setupCursoGlobalProgress: shows tronco-único progress (103 etapas)
...
(function () {
  ...
  // ---------- Tronco único — global progress (103 etapas) ----------
  ...
  const ETAPAS = [
    ...
    { slug: 'etapa-100-ensayo-trabajo', total: 4, title: 'Ensayo tema-bisagra — Trabajo', phase: 8 },
    { slug: 'etapa-101-ensayo-estado', total: 4, title: 'Ensayo tema-bisagra — Estado', phase: 8 },
    { slug: 'etapa-102-ensayo-desigualdad', total: 4, title: 'Ensayo tema-bisagra — Desigualdad', phase: 8 },
    { slug: 'etapa-103-tesina-final', total: 6, title: 'Tesina final integrada (8-10k palabras, 1 tema-bisagra)', phase: 8 },
    ...
    { slug: 'etapa-18-constant-libertad', total: 3, title: 'Constant — La libertad de los antiguos comparada con la de los modernos', phase: 1 },
    { slug: 'etapa-19-tocqueville-democracia-en-america', total: 4, title: 'Tocqueville — La democracia en América (selección)', phase: 1 },
    { slug: 'etapa-20-pocock-momento-maquiavelico', total: 7, title: 'Pocock — El momento maquiavélico (selección)', phase: 1 },
    { slug: 'etapa-21-pateman-mills-contrato', total: 4, title: 'Pateman & Mills — El contrato sexual y el contrato racial', phase: 1 },
    { slug: 'etapa-22-chang-economia-99', total: 4, title: 'Chang — Economía para el 99% (10 caps. seleccionados)', phase: 2 },
    { slug: 'etapa-23-smith-riqueza-naciones', total: 5, title: 'Smith — La riqueza de las naciones (Libros I y IV)', phase: 2 },
    { slug: 'etapa-24-ricardo-economia-politica', total: 4, title: 'Ricardo — Principios de economía política y tributación', phase: 2 },
    { slug: 'etapa-25-hegel-fenomenologia', total: 4, title: 'Hegel — Fenomenología del Espíritu + Filosofía del derecho', phase: 2 },
    { slug: 'etapa-26-marx-capital', total: 4, title: 'Marx — El Capital Libro I (caps. 1, 4, 24)', phase: 2 },
    { slug: 'etapa-27-harvey-reading-marx', total: 4, title: 'Harvey — Reading Marx\'s Capital (13 clases video)', phase: 2 },
    { slug: 'etapa-28-federici-caliban-bruja', total: 4, title: 'Federici — Calibán y la bruja', phase: 2 },
    { slug: 'etapa-29-mariategui-7-ensayos', total: 5, title: 'Mariátegui — 7 Ensayos de interpretación (II-III)', phase: 2 },
    { slug: 'etapa-30-weber-politica-vocacion', total: 4, title: 'Weber — La política como vocación', phase: 3 },
    { slug: 'etapa-31-foucault', total: 6, title: 'Foucault — Vigilar y castigar / Nacimiento de la biopolítica', phase: 3 },
    { slug: 'etapa-32-arendt-condicion-humana', total: 4, title: 'Hannah Arendt — La condición humana', phase: 3 },
    { slug: 'etapa-33-schmitt-concepto-politico', total: 4, title: 'Carl Schmitt — El concepto de lo político / Teología política', phase: 3 },
    { slug: 'etapa-34-rawls-teoria-justicia', total: 5, title: 'Rawls — Teoría de la Justicia (caps. I y III)', phase: 3 },
    { slug: 'etapa-35-berlin-dos-conceptos', total: 4, title: 'Berlin — Dos conceptos de libertad', phase: 3 },
    { slug: 'etapa-36-pettit-skinner-republicanismo', total: 4, title: 'Pettit & Skinner — Republicanismo contemporáneo', phase: 3 },
    { slug: 'etapa-37-habermas-esfera-publica', total: 6, title: 'Habermas — Esfera pública (selección)', phase: 3 },
    { slug: 'etapa-38-laclau-mouffe-hegemonia', total: 4, title: 'Laclau & Mouffe — Hegemonía y agonismo democrático', phase: 3 },
    { slug: 'etapa-39-lenin-imperialismo', total: 4, title: 'Lenin — El imperialismo, fase superior del capitalismo', phase: 3 },
    { slug: 'etapa-40-gramsci-cuadernos', total: 5, title: 'Gramsci — Cuadernos desde la prisión (selección Hoare-Smith)', phase: 3 },
    { slug: 'etapa-41-hayek-camino-servidumbre', total: 6, title: 'Hayek — Camino de servidumbre (caps. 1, 3, 5-7)', phase: 3 },
    { slug: 'etapa-42-menger-economia-politica', total: 4, title: 'Carl Menger — Principios de economía política', phase: 3 },
    { slug: 'etapa-43-popper-sociedad-abierta', total: 5, title: 'Popper — La sociedad abierta y sus enemigos', phase: 3 },
    { slug: 'etapa-44-nozick-anarquia-estado-utopia', total: 4, title: 'Nozick — Anarquía, Estado y utopía (Partes I y III)', phase: 3 },
    { slug: 'etapa-45-keynes-teoria-general', total: 4, title: 'Keynes — Teoría general de la ocupación, el interés y el dinero', phase: 3 },
    { slug: 'etapa-46-hardin-ostrom-comunes', total: 4, title: 'Hardin & Ostrom — La tragedia y el gobierno de los comunes', phase: 3 },
    { slug: 'etapa-47-fraser-honneth-redistribucion', total: 4, title: 'Fraser & Honneth — ¿Redistribución o reconocimiento?', phase: 3 },
    { slug: 'etapa-48-bolivar-carta-jamaica', total: 6, title: 'Bolívar — Carta de Jamaica', phase: 4 },
    { slug: 'etapa-49-marti-nuestra-america', total: 6, title: 'Martí — Nuestra América', phase: 4 },
    { slug: 'etapa-50-rodo-ariel', total: 4, title: 'Rodó — Ariel', phase: 4 },
    { slug: 'etapa-51-vasconcelos-raza-cosmica', total: 5, title: 'Vasconcelos — La raza cósmica', phase: 4 },
    { slug: 'etapa-52-paz-laberinto-soledad', total: 4, title: 'Paz — El laberinto de la soledad', phase: 4 },
    { slug: 'etapa-53-galeano-venas-abiertas', total: 4, title: 'Galeano — Las venas abiertas de América Latina', phase: 4 },
    { slug: 'etapa-54-bueno-mito-izquierda', total: 5, title: 'Bueno — El mito de la izquierda (selección)', phase: 4 },
    { slug: 'etapa-55-echeverria-modernidad-blanquitud', total: 4, title: 'Bolívar Echeverría — Modernidad y blanquitud', phase: 4 },
    { slug: 'etapa-56-dussel-1492', total: 7, title: 'Dussel — 1492: el encubrimiento del Otro', phase: 4 },
    { slug: 'etapa-57-quijano-colonialidad', total: 3, title: 'Quijano — Colonialidad del poder', phase: 4 },
    { slug: 'etapa-58-cusicanqui-chixinakax', total: 5, title: 'Cusicanqui — Ch\'ixinakax utxiwa', phase: 4 },
    { slug: 'etapa-59-freire-pedagogia-oprimido', total: 5, title: 'Freire — Pedagogía del oprimido (caps. 1-2)', phase: 4 },
    { slug: 'etapa-60-gutierrez-teologia-liberacion', total: 4, title: 'Gutiérrez — Teología de la liberación (selección)', phase: 4 },
    { slug: 'etapa-61-gonzalez-feminismo-afrolatinoamericano', total: 4, title: 'Lélia González — Por un feminismo afrolatinoamericano', phase: 4 },
    { slug: 'etapa-62-crenshaw-interseccionalidad', total: 4, title: 'Crenshaw — Interseccionalidad y cartografía de los márgenes', phase: 4 },
    { slug: 'etapa-63-lugones-heterosexualismo', total: 4, title: 'Lugones — Heterosexualismo y sistema de género colonial moderno', phase: 4 },
    { slug: 'etapa-64-gago-potencia-feminista', total: 4, title: 'Gago — La potencia feminista', phase: 4 },
    { slug: 'etapa-65-segato-guerra-mujeres', total: 6, title: 'Segato — La guerra contra las mujeres', phase: 4 },
    { slug: 'etapa-66-wallerstein-sistemas-mundo', total: 5, title: 'Wallerstein — Análisis de sistemas-mundo (selección)', phase: 5 },
    { slug: 'etapa-67-mearsheimer-great-power', total: 6, title: 'Mearsheimer — The Tragedy of Great Power Politics', phase: 5 },
    { slug: 'etapa-68-agamben', total: 4, title: 'Agamben — Homo Sacer / Estado de excepción', phase: 5 },
    { slug: 'etapa-69-fanon-condenados-tierra', total: 4, title: 'Frantz Fanon — Los condenados de la tierra', phase: 5 },
    { slug: 'etapa-70-said-orientalismo', total: 5, title: 'Edward Said — Orientalismo', phase: 5 },
    { slug: 'etapa-71-spivak-subalterno', total: 4, title: 'Gayatri Spivak — ¿Puede hablar el subalterno?', phase: 5 },
    { slug: 'etapa-72-chibber-teoria-poscolonial', total: 4, title: 'Chibber — La teoría poscolonial y el espectro del capital', phase: 5 },
    { slug: 'etapa-73-mbembe-necropolitica', total: 4, title: 'Mbembe — Necropolítica', phase: 5 },
    { slug: 'etapa-74-novela-politica', total: 4, title: 'Novela Política Latinoamericana — La Dictadura y el Poder', phase: 5 },
    { slug: 'etapa-75-relectura-activa', total: 3, title: 'Relectura activa de un libro de Fases 1-4 que te marcó', phase: 5 },
    { slug: 'etapa-76-gandhi-hind-swaraj', total: 4, title: 'Gandhi — Hind Swaraj', phase: 5 },
    { slug: 'etapa-77-confucio-analectas', total: 4, title: 'Confucio — Analectas (selección)', phase: 5 },
    { slug: 'etapa-78-sen-identidad-violencia', total: 4, title: 'Sen — Identidad y violencia', phase: 5 },
    { slug: 'etapa-79-hardt-negri-imperio', total: 5, title: 'Hardt and Negri — Imperio (caps. 1-4)', phase: 5 },
    { slug: 'etapa-80-wang-hui', total: 5, title: 'Wang Hui — El nuevo orden de China', phase: 5 },
    { slug: 'etapa-81-maruyama', total: 4, title: 'Maruyama — Pensamiento político de Japón moderno', phase: 5 },
    { slug: 'etapa-82-ambedkar-annihilation-caste', total: 4, title: 'Ambedkar — Annihilation of Caste', phase: 5 },
    { slug: 'etapa-83-ensayo-final', total: 5, title: 'Ensayo final integrador (1500-2000 palabras)', phase: 5 },
    { slug: 'etapa-84-grabacion-final', total: 4, title: 'Grabación oral final (10 minutos, sin notas)', phase: 5 },
    { slug: 'etapa-85-marshall-ciudadania', total: 5, title: 'Marshall — Ciudadanía y clase social', phase: 6 },
    { slug: 'etapa-86-polanyi-gran-transformacion', total: 6, title: 'Polanyi — La gran transformación (caps. 4, 6, 11-14)', phase: 6 },
    { slug: 'etapa-87-esping-andersen', total: 4, title: 'Esping-Andersen — Los tres mundos del Estado del bienestar', phase: 6 },
    { slug: 'etapa-88-filgueira-universalismo-basico', total: 4, title: 'Filgueira et al. — Universalismo básico en América Latina', phase: 6 },
    { slug: 'etapa-89-tesina-m5', total: 5, title: 'Tesina módulo M5: qué tipo de welfare es el argentino', phase: 6 },
    { slug: 'etapa-90-horkheimer-adorno-industria-cultural', total: 4, title: 'Horkheimer & Adorno — La industria cultural', phase: 7 },
    { slug: 'etapa-91-williams-marxismo-literatura', total: 4, title: 'Williams — Marxismo y literatura', phase: 7 },
    { slug: 'etapa-92-benjamin-obra-arte', total: 4, title: 'Benjamin — La obra de arte en la época de su reproductibilidad técnica', phase: 7 },
    { slug: 'etapa-93-bourdieu-distincion', total: 6, title: 'Bourdieu — La distinción (caps. 1 y 3)', phase: 7 },
    { slug: 'etapa-94-hall-encoding-decoding', total: 4, title: 'Hall — Encoding/Decoding', phase: 7 },
    { slug: 'etapa-95-garcia-canclini-culturas-hibridas', total: 4, title: 'García Canclini — Culturas híbridas (selección)', phase: 7 },
    { slug: 'etapa-96-martin-barbero', total: 4, title: 'Martín-Barbero — De los medios a las mediaciones (Parte III)', phase: 7 },
    { slug: 'etapa-97-zuboff-vigilancia', total: 6, title: 'Zuboff — La era del capitalismo de la vigilancia (selección)', phase: 7 },
    { slug: 'etapa-98-ensayo-neoliberalismo', total: 4, title: 'Ensayo tema-bisagra — Neoliberalismo', phase: 8 },
    { slug: 'etapa-99-ensayo-ciudadania', total: 4, title: 'Ensayo tema-bisagra — Ciudadanía', phase: 8 },
  ];
