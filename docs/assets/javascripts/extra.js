...
(function () {
  ...
  const ETAPAS = [
    ...
    { slug: 'etapa-19-pocock-momento-maquiavelico', total: 6, title: 'Pocock — El momento maquiavélico (selección)', phase: 1 },
    { slug: 'etapa-20-chang-economia-99', total: 4, title: 'Chang — Economía para el 99% (10 caps. seleccionados)', phase: 2 },
    { slug: 'etapa-21-smith-riqueza-naciones', total: 4, title: 'Smith — La riqueza de las naciones (Libros I y IV)', phase: 2 },
    ...
    { slug: 'etapa-27-foucault', total: 5, title: 'Foucault — Vigilar y castigar / Nacimiento de la biopolítica', phase: 3 },
    ...
    { slug: 'etapa-30-habermas-esfera-publica', total: 5, title: 'Habermas — Esfera pública (selección)', phase: 3 },
    ...
    { slug: 'etapa-33-hayek-camino-servidumbre', total: 4, title: 'Hayek — Camino de servidumbre (caps. 1, 3, 5-7)', phase: 3 },
    ...
    { slug: 'etapa-49-gonzalez-feminismo-afrolatinoamericano', total: 3, title: 'Lélia González — Por un feminismo afrolatinoamericano', phase: 4 },
    { slug: 'etapa-50-lugones-heterosexualismo', total: 3, title: 'Lugones — Heterosexualismo y sistema de género colonial moderno', phase: 4 },
    { slug: 'etapa-51-gago-potencia-feminista', total: 4, title: 'Gago — La potencia feminista', phase: 4 },
    { slug: 'etapa-52-segato-guerra-mujeres', total: 5, title: 'Segato — La guerra contra las mujeres', phase: 4 },
    { slug: 'etapa-53-wallerstein-sistemas-mundo', total: 4, title: 'Wallerstein — Análisis de sistemas-mundo (selección)', phase: 5 },
    { slug: 'etapa-54-mearsheimer-great-power', total: 5, title: 'Mearsheimer — The Tragedy of Great Power Politics', phase: 5 },
    ...
    { slug: 'etapa-57-said-orientalismo', total: 4, title: 'Edward Said — Orientalismo', phase: 5 },
    ...
    { slug: 'etapa-65-wang-hui', total: 4, title: 'Wang Hui — El nuevo orden de China', phase: 5 },
    ...
    { slug: 'etapa-71-polanyi-gran-transformacion', total: 5, title: 'Polanyi — La gran transformación (caps. 4, 6, 11-14)', phase: 6 },
    ...
    { slug: 'etapa-77-bourdieu-distincion', total: 5, title: 'Bourdieu — La distinción (caps. 1 y 3)', phase: 7 },
    ...
    { slug: 'etapa-81-zuboff-vigilancia', total: 4, title: 'Zuboff — La era del capitalismo de la vigilancia (selección)', phase: 7 },
