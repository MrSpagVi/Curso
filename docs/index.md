...
- **Detección de falacias** — captura diaria de argumentos malos en tu log, clasificados por familia y nombre.
- **IA con guardrails** — 5 prompts canónicos (devil's advocate, sintetizá esto, dame contraejemplos, etc.) usada SIEMPRE después de leer y escribir, nunca antes.
- **Producción propia** — ensayo final de 1500-2000 palabras + grabación oral de 10 min + tesina integradora de 8-10k palabras.
...
3. **Habilidad de detectar y nombrar falacias** en el discurso público con criterio.
4. **Una voz política propia con criterio** — defendida en un ensayo publicable + grabación + tesina.
5. **Un archivo personal** de ~80 fichas de lectura + 50-100 notas permanentes propias.

---

## Cómo lograrlo

**Una etapa a la vez. En orden. Sin saltos.** Cada etapa tiene:

- **Microsummary** (1-2 líneas: qué hacés, por qué importa).
- **Contexto teórico/histórico** (información completa que tenés que leer).
- **Tareas concretas** (checkboxes) — el material a leer/ver/producir.
- **Cómo se estudia esta etapa** (ritmo, anti-patrones, qué priorizar).
...
<section class="g-section">
  <span class="g-label">Mantra del proyecto</span>
  <blockquote class="g-mantra">
    Constancia &gt; intensidad. <strong>3-5 h/sem sostenidas</strong> durante 36 meses te llevan más lejos que sprints heroicos seguidos de meses muertos. <strong>2 h/sem también vale</strong>: el plan se estira, no se rompe. Si una semana no podés con todo, mantené el ritual diario de 10 min y suspendé lo demás. No se elige ruta, no hay atajos, no hay opciones. Solo una secuencia honesta.
  </blockquote>
</section>

<div style="text-align:center;margin:2rem 0;">
  <a href="etapas/etapa-01-setup-sistema-de-notas/" class="g-btn g-btn-primary hero-cta-xl">▶ Empezar por la Etapa 1</a>
</div>
